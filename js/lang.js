...
const translations = {
    'en': {
        'img': 'Image generated by AI under commercial license',
        'maj': 'Last update: 2023/11/10',
        'contact': 'Contact',
        'cv': 'Curriculum Vitae',
        'general': 'general',
    ...
    'fr': {
        'img': 'Image génére par IA sous licence commercial',
        'maj': 'Dernière mise à jour : 10/11/2023',
        'contact': 'Contact',
        'cv': 'Curriculum Vitae',
        'general': 'général',
    ...
    'ja': {
        'img': '商用ライセンスに基づきAIが作成した画像',
        'maj': '最終更新日: 2023/11/10',
        'contact': '連絡先',
        'cv': '履歴書',
        'general': '一般',
